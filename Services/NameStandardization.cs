...
public static class NameStandardization
{
    private static Dictionary<string, string> iseitai = new Dictionary<string, string>() {
            {"邉","辺" },
            {"邊","辺" },
            {"髙","高" },
            {"槗","橋" },
    ...
    public static string ConvertKana(string kana)
    {
        return KanaEx.ToZenkakuKana(kana).Replace("　", " ");
    }
}
